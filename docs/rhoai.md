...
3) Access the `workbench` named `test-chatbot-rolling-demo-25041003-notebook`.
...
5) In the terminal, run `cd test-chatbot-rolling-demo-25041003` to navigate to your sample app's directory.
